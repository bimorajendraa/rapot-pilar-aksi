...
async function seed() {
    console.warn('PERINGATAN: Seed ini akan MENG-HAPUS (TRUNCATE) isi tabel members & departments sebelum mengisi ulang.');
    console.warn('JANGAN jalankan seed di production setelah data asli (score/band/assessment) masuk, karena data akan direset.');
    ...
    try {
        ...
        // Di Aiven, database biasanya sudah dibuat otomatis dan user tidak
        // selalu punya privilege CREATE DATABASE — kegagalan di sini diabaikan.
        try {
            ...
            console.warn('Lewati pembuatan database (mungkin sudah ada / tidak diizinkan):', dbCreateErr.message);
        }
